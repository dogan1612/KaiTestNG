...
public class TestBase {
    ...
    protected static ExtentReports report;                          // We are instantiating these classes in test base
    protected static ExtentHtmlReporter htmlReporter;               // we need this objects for building reports
